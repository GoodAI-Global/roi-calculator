  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
        <span className="w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center text-sm mr-3">
          !
        </span>
        Transparency Report
      </h2>
      ...
      <div className="mt-6 p-3 bg-gray-50 rounded-lg border border-gray-200">
        <p className="text-xs text-gray-500 italic">
          Good AI believes in transparency. Unlike vendor calculators that hide assumptions to
          inflate ROI projections, we show everything. Real decisions require real data.
        </p>
      </div>
    </div>
  );
