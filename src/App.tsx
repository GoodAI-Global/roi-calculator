    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
          <Calculator selectedIndustry={selectedIndustry} onIndustryChange={setSelectedIndustry} />
        </main>
        ...
        <footer className="bg-gray-100 border-t border-gray-200 py-6 mt-12">
          <div className="max-w-6xl mx-auto px-4 text-center text-sm text-gray-600">
            <p className="mb-2">
              <strong>Methodology:</strong> Calculations based on industry benchmarks (p50 median
              values).
            </p>
            <p className="text-xs text-gray-500">
              This calculator provides estimates only. Actual results depend on implementation
              quality, data availability, and organizational readiness. Consult with experts before
              making investment decisions.
            </p>
            <p className="mt-4 text-goodai-teal font-medium">Good AI — Evidence over opinions</p>
          </div>
        </footer>
      </div>
    </ErrorBoundary>
